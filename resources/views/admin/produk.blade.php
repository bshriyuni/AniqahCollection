...
<body>
    ...
    <nav class="navbar navbar-expand-lg " style="background-color: #BBD6B8; text-align :center;" >
    ...
    <br>
    <div id="most">
        <div class="container" style="background-color: #BBD6B8; width:60px height:40px">
            <div class="container1" style="width: 40rem; height: 20rem">
                <div class="container" style="width: 18rem; height: 18rem">
